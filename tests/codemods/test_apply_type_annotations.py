...
class TestApplyAnnotationsVisitor(CodemodTest):
    ...
    def run_simple_test_case(
        ...
        ApplyTypeAnnotationsVisitor.store_stub_in_context(context, parse_module(textwrap.dedent(stub.rstrip())))
    ...
    def test_annotate_simple_functions(self, stub: str, before: str, after: str) -> None:
        self.run_simple_test_case(stub=stub, before=before, after=after)
    ...
    def test_annotate_using_incomplete_stubs(self, stub: str, before: str, after: str) -> None:
        """
    ...
    def test_count_annotations(
        ...
        context = CodemodContext()
        ApplyTypeAnnotationsVisitor.store_stub_in_context(context=context, stub=parse_module(stub))
        ...
        self.assertEqual(any_changes_applied, visitor.annotation_counts.any_changes_applied())
