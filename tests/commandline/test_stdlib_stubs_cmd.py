"""Tests for the stdlib-stubs command."""
...
def test_cmd_stdlib_stubs_help():
    ...
    runner = CliRunner()
    result = runner.invoke(stubber.stubber_cli, ["stdlib-stubs", "--help"])
...
def test_cmd_stdlib_stubs_no_build(mocker: MockerFixture, tmp_path: Path):
    """Test stdlib-stubs command without building."""
    runner = CliRunner()
    ...
    m_update_mpy_shed = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.update_mpy_shed"
    )
    m_update_asyncio = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.update_asyncio_manual"
    )
    m_post_processing = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.do_post_processing"
    )
    m_add_type_ignore = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.add_type_ignore"
    )
    ...
    m_update_typing = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.update_typing_pyi"
    )
    ...
    result = runner.invoke(
        stubber.stubber_cli,
        ["stdlib-stubs", "--no-build", "--no-merge", "--no-typeshed"],
    )
...
def test_cmd_stdlib_stubs_with_merge(mocker: MockerFixture, tmp_path: Path):
    """Test stdlib-stubs command with merge option."""
    runner = CliRunner()
    ...
    m_merge = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.merge_docstubs_into_stdlib"
    )
    ...
    result = runner.invoke(
        stubber.stubber_cli,
        ["stdlib-stubs", "--no-build", "--merge", "--no-typeshed"],
    )
...
def test_cmd_stdlib_stubs_with_typeshed(mocker: MockerFixture, tmp_path: Path):
    """Test stdlib-stubs command with typeshed update."""
    runner = CliRunner()
    ...
    m_update_typeshed = mocker.patch(
        "stubber.commands.stdlib_stubs_cmd.update_stdlib_from_typeshed"
    )
    ...
    result = runner.invoke(
        stubber.stubber_cli,
        ["stdlib-stubs", "--no-build", "--no-merge", "--typeshed"],
    )
...
def test_cmd_stdlib_stubs_version_option(mocker: MockerFixture, tmp_path: Path):
    """Test stdlib-stubs command with explicit version."""
    runner = CliRunner()
    ...
    result = runner.invoke(
        stubber.stubber_cli,
        ["stdlib-stubs", "--no-build", "--no-merge", "--no-typeshed", "-v", "1.23.0"],
    )
