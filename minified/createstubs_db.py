...
def U(path):
	...
	while A!=-1:
		...
		E=A+1
def _info():
	g=' on ';f='0.0.0';e='port';d='platform';c='machine';b='nodename';a='name';U='mpy';T='unknown';R='-';Q='sysname';N='v';L='build';F='family';C='ver';B='release';V=sys.implementation.name;W=sys.platform;A={a:V,B:f,O:f,L:G,Q:T,b:T,c:T,F:V,d:W,e:W,C:G}
