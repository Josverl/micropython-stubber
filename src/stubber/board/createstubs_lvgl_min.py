...
def _info():
	e='ev3-pybricks';c='pycom';b='pycopy';a='unix';Z='win32';Y='arch';X='ver';K='mpy';G='port';F='build';A=d({L:sys.implementation.name,D:B,F:B,X:B,G:sys.platform,J:'UNKNOWN',U:B,K:B,Y:B})
