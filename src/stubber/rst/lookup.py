...
PARAM_FIXES = [
    ...
    #     def __init__(self, id, *, scl:Optional[Pin]=None, sda:Optional[Pin]=None, freq=400000) -> None: ...
    ("id, *, scl, sda, freq=400000", "id, *, scl:Optional[Pin]=None, sda:Optional[Pin]=None, freq=400_000"),
    # network.WLAN
