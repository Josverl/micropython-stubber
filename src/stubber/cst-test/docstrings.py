...
#         docstring = node.get_docstring(clean=False)  # lgtm [py/unused-local-variable]
...
# print("".join(difflib.unified_diff(py_source.splitlines(True), modified_tree.code.splitlines(True))))
