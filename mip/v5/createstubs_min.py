...
def _info():
	e='ev3-pybricks';c='pycopy';b='unix';a='win32';Z='arch';X='ver';K='mpy';G='port';F='build';A=f({L:sys.implementation.name,D:B,F:B,X:B,G:sys.platform,I:'UNKNOWN',U:B,K:B,Z:B})
