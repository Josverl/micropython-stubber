...
class Stubber():
    ...
    def __init__(self, path: str = None, firmware_id: str = None, **kwargs):
        ...
        self.modules = ['_thread', 'ak8963', 'apa102', 'apa106', 'array', 'bluetooth', 'binascii', 'btree', 'builtins', 'cmath', 'collections', 
            ...
            'ssh', 'ssl', 'struct', 'sys', 'time', 'tpcalib', 'uasyncio/core', 'ubluetooth', 'ubinascii', 'ucollections', 'ucryptolib',
            'uctypes', 'uerrno', 'uhashlib', 'uheapq', 'uio', 'ujson', 'umqtt/robust', 'umqtt/simple', 'uos', 'upip', 'upip_utarfile', 'urandom', 
